...
set files [list \
	[ file normalize "$origin_dir/xdc/timing_216_q3diamond.xdc"] 	\
	[ file normalize "$origin_dir/xdc/ios_216_q3diamond.xdc"] 	\
]
add_files -fileset $obj $files

# Source Block Design.
set file "[file normalize "$origin_dir/bd/bd_216_q3diamond_2022-1.tcl"]"
source $file
