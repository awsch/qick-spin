...
set_property PULLDOWN TRUE         [get_ports "PMOD1_0_LS"] ; # Add pulldown, to set 0 if not connected
...
set_property PULLDOWN TRUE         [get_ports "PMOD1_1_LS"] ;# # Add pulldown, to set 0 if not connected
...
#set_property PULLDOWN TRUE         [get_ports "PMOD1_4_LS"] ;# # Add pulldown, to set 0 if not connected
...
#set_property PULLDOWN TRUE         [get_ports "PMOD1_5_LS"] ;# # Add pulldown, to set 0 if not connected
...
#set_property PULLDOWN TRUE         [get_ports "PMOD1_6_LS"] ;# # Add pulldown, to set 0 if not connected
...
#set_property PULLDOWN TRUE         [get_ports "PMOD1_7_LS"] ;# # Add pulldown, to set 0 if not connected

## LED RED IS PMOD INPUT
#set_property PACKAGE_PIN AN14      [get_ports "LED_PMOD1_4"] ;# Bank  64 VCCO - VCC1V2   - IO_T3U_N12_64
#set_property IOSTANDARD  LVCMOS12  [get_ports "LED_PMOD1_4"] ;# Bank  64 VCCO - VCC1V2   - IO_T3U_N12_64
#set_property PACKAGE_PIN AP16      [get_ports "LED_PMOD1_5"] ;# Bank  64 VCCO - VCC1V2   - IO_L19N_T3L_N1_DBC_AD9N_64
#set_property IOSTANDARD  LVCMOS12  [get_ports "LED_PMOD1_5"] ;# Bank  64 VCCO - VCC1V2   - IO_L19N_T3L_N1_DBC_AD9N_64
#set_property PACKAGE_PIN AP14      [get_ports "LED_PMOD1_6"] ;# Bank  64 VCCO - VCC1V2   - IO_T2U_N12_64
#set_property IOSTANDARD  LVCMOS12  [get_ports "LED_PMOD1_6"] ;# Bank  64 VCCO - VCC1V2   - IO_T2U_N12_64
#set_property PACKAGE_PIN AU16      [get_ports "LED_PMOD1_7"] ;# Bank  64 VCCO - VCC1V2   - IO_L13N_T2L_N1_GC_QBC_64
#set_property IOSTANDARD  LVCMOS12  [get_ports "LED_PMOD1_7"] ;# Bank  64 VCCO - VCC1V2   - IO_L13N_T2L_N1_GC_QBC_64

## LED GREEN 
#set_property PACKAGE_PIN C13       [get_ports "LED_GPIO_0"] ;# Bank  87 VCCO - VCC1V8   - IO_L3N_AD13N_87
#set_property IOSTANDARD  LVCMOS18  [get_ports "LED_GPIO_0"] ;# Bank  87 VCCO - VCC1V8   - IO_L3N_AD13N_87
#set_property PACKAGE_PIN D14       [get_ports "LED_GPIO_1"] ;# Bank  87 VCCO - VCC1V8   - IO_L3P_AD13P_87
#set_property IOSTANDARD  LVCMOS18  [get_ports "LED_GPIO_1"] ;# Bank  87 VCCO - VCC1V8   - IO_L3P_AD13P_87
#set_property PACKAGE_PIN D12       [get_ports "LED_GPIO_2"] ;# Bank  87 VCCO - VCC1V8   - IO_L2N_AD14N_87
#set_property IOSTANDARD  LVCMOS18  [get_ports "LED_GPIO_2"] ;# Bank  87 VCCO - VCC1V8   - IO_L2N_AD14N_87
