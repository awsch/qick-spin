...
set _xil_proj_name_ "top_216_jac"
...
set files [list \
	[ file normalize "$origin_dir/xdc/timing_216_jac.xdc"] 	\
	[ file normalize "$origin_dir/xdc/ios_216_jac.xdc"] 	\
]
add_files -fileset $obj $files

# Source Block Design.
set file "[file normalize "$origin_dir/bd/bd_216_jac_2022-1.tcl"]"
source $file
